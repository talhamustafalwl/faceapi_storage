...
$(document).ready(function(){
    ...
    $('#train').submit(function(event){
        ...
        if(train_data.name && train_data.file){
            ...
            message = {type: "error", message: "Name and face image required."}
    ...
    $('#recognize').submit(function(e){
        ...
        axios.post('/api/recognize', recog_form_data).then(function(response){
            console.log("User matched with your face is", response.data);
            message = {type: 'success', message: 'User matched with your face is: '+ response.data.user.name};
